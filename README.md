...
To learn more about configuration, usage and features of irc.imperialfamily.com, take a look at [the website](https://thelounge.chat).

irc.imperialfamily.com is the official and community-managed fork of [Shout](https://github.com/erming/shout), by [Mattias Erming](https://github.com/erming).

## Installation and usage

irc.imperialfamily.com requires latest [Node.js](https://nodejs.org/) LTS version or more recent.
